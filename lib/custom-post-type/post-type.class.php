...
class PostType{
	...
	public function add_type($nome_plural, $nome_singular, $slug, $feminino = false, $icone = 'dashicons-admin-generic', $supports = array('title', 'thumbnail', 'excerpt', 'page_attributes','editor','author'),$search = false,$rewrite = '', $public = true, $publicly_queryable = true, $show_ui = true, $show_in_menu = true,$has_archive = true){
